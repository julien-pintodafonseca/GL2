...
public class TestRegisterManager {
    ...
    private final DecacFatalError expectedWrongReg8Ex =
            new DecacFatalError(ErrorMessages.DECAC_FATAL_ERROR_REGISTER_MANAGER_WRONG_REG_NUMBER+8);
    private final DecacFatalError expectedWrongReg1Ex =
            new DecacFatalError(ErrorMessages.DECAC_FATAL_ERROR_REGISTER_MANAGER_WRONG_REG_NUMBER+1);
