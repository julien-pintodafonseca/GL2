...
public class TestLower {
    ...
    public void testIntInt() throws ContextualError, DecacFatalError {
        Lower lower = new Lower(intexpr1, intexpr2);
        // check the result
        assertTrue(lower.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should not have been inserted
        assertFalse(lower.getRightOperand() instanceof ConvFloat);
        assertFalse(lower.getLeftOperand() instanceof ConvFloat);
    ...
    public void testIntFloat() throws ContextualError, DecacFatalError {
        Lower lower = new Lower(intexpr1, floatexpr2);
        // check the result
        assertTrue(lower.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should have been inserted on the right side
        assertTrue(lower.getLeftOperand() instanceof ConvFloat);
        assertFalse(lower.getRightOperand() instanceof ConvFloat);
        // check that the mocks have been called properly.
        verify(intexpr1).verifyExpr(compiler, null, null);
    ...
    public void testFloatInt() throws ContextualError, DecacFatalError {
        Lower lower = new Lower(floatexpr1, intexpr2);
        // check the result
        assertTrue(lower.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should have been inserted on the right side
        assertTrue(lower.getRightOperand() instanceof ConvFloat);
        assertFalse(lower.getLeftOperand() instanceof ConvFloat);
        // check that the mocks have been called properly.
    ...
    public void testFloatFloat() throws ContextualError, DecacFatalError {
        Lower lower = new Lower(floatexpr1, floatexpr2);
        // check the result
        assertTrue(lower.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should not have been inserted
        assertFalse(lower.getRightOperand() instanceof ConvFloat);
    ...
    public void testWrongTypes() throws ContextualError {
        ...
        Lower lower1 = new Lower(stringExpr1, anyFloatExpr);
        ...
        ContextualError result1 = assertThrows(ContextualError.class, () -> {
            lower1.verifyExpr(compiler, null, null);
        });
        ...
        Lower lower2 = new Lower(anyFloatExpr, booleanExpr2);
        ...
        ContextualError result2 = assertThrows(ContextualError.class, () -> {
            lower2.verifyExpr(compiler, null, null);
        });
