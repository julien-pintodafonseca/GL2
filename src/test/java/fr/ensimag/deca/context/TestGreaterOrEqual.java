...
public class TestGreaterOrEqual {
    ...
    public void testIntInt() throws ContextualError, DecacFatalError {
        GreaterOrEqual greaterOrEqual = new GreaterOrEqual(intexpr1, intexpr2);
        // check the result
        assertTrue(greaterOrEqual.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should not have been inserted
        assertFalse(greaterOrEqual.getRightOperand() instanceof ConvFloat);
        assertFalse(greaterOrEqual.getLeftOperand() instanceof ConvFloat);
    ...
    public void testIntFloat() throws ContextualError, DecacFatalError {
        GreaterOrEqual greaterOrEqual = new GreaterOrEqual(intexpr1, floatexpr2);
        // check the result
        assertTrue(greaterOrEqual.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should have been inserted on the right side
        assertTrue(greaterOrEqual.getLeftOperand() instanceof ConvFloat);
        assertFalse(greaterOrEqual.getRightOperand() instanceof ConvFloat);
        // check that the mocks have been called properly.
        verify(intexpr1).verifyExpr(compiler, null, null);
    ...
    public void testFloatInt() throws ContextualError, DecacFatalError {
        GreaterOrEqual greaterOrEqual = new GreaterOrEqual(floatexpr1, intexpr2);
        // check the result
        assertTrue(greaterOrEqual.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should have been inserted on the right side
        assertTrue(greaterOrEqual.getRightOperand() instanceof ConvFloat);
        assertFalse(greaterOrEqual.getLeftOperand() instanceof ConvFloat);
        // check that the mocks have been called properly.
    ...
    public void testFloatFloat() throws ContextualError, DecacFatalError {
        GreaterOrEqual greaterOrEqual = new GreaterOrEqual(floatexpr1, floatexpr2);
        // check the result
        assertTrue(greaterOrEqual.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should not have been inserted
        assertFalse(greaterOrEqual.getRightOperand() instanceof ConvFloat);
    ...
    public void testWrongTypes() throws ContextualError {
        ...
        GreaterOrEqual greaterOrEqual1 = new GreaterOrEqual(stringExpr1, anyFloatExpr);
        ...
        ContextualError result1 = assertThrows(ContextualError.class, () -> {
            greaterOrEqual1.verifyExpr(compiler, null, null);
        });
        ...
        GreaterOrEqual greaterOrEqual2 = new GreaterOrEqual(anyFloatExpr, booleanExpr2);
        ...
        ContextualError result2 = assertThrows(ContextualError.class, () -> {
            greaterOrEqual2.verifyExpr(compiler, null, null);
        });
