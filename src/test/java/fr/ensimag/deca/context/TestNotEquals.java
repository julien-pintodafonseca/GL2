...
public class TestNotEquals {
    ...
    public void testIntInt() throws ContextualError, DecacFatalError {
        NotEquals notEquals = new NotEquals(intexpr1, intexpr2);
        // check the result
        assertTrue(notEquals.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should not have been inserted
        assertFalse(notEquals.getRightOperand() instanceof ConvFloat);
        assertFalse(notEquals.getLeftOperand() instanceof ConvFloat);
    ...
    public void testIntFloat() throws ContextualError, DecacFatalError {
        NotEquals notEquals = new NotEquals(intexpr1, floatexpr2);
        // check the result
        assertTrue(notEquals.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should have been inserted on the right side
        assertTrue(notEquals.getLeftOperand() instanceof ConvFloat);
        assertFalse(notEquals.getRightOperand() instanceof ConvFloat);
        // check that the mocks have been called properly.
        verify(intexpr1).verifyExpr(compiler, null, null);
    ...
    public void testFloatInt() throws ContextualError, DecacFatalError {
        NotEquals notEquals = new NotEquals(floatexpr1, intexpr2);
        // check the result
        assertTrue(notEquals.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should have been inserted on the right side
        assertTrue(notEquals.getRightOperand() instanceof ConvFloat);
        assertFalse(notEquals.getLeftOperand() instanceof ConvFloat);
        // check that the mocks have been called properly.
    ...
    public void testFloatFloat() throws ContextualError, DecacFatalError {
        NotEquals notEquals = new NotEquals(floatexpr1, floatexpr2);
        // check the result
        assertTrue(notEquals.verifyExpr(compiler, null, null).isBoolean());
        // ConvFloat should not have been inserted
        assertFalse(notEquals.getRightOperand() instanceof ConvFloat);
    ...
    public void testWrongTypes() throws ContextualError {
        ...
        NotEquals notEquals1 = new NotEquals(stringExpr1, anyFloatExpr);
        ...
        ContextualError result1 = assertThrows(ContextualError.class, () -> {
            notEquals1.verifyExpr(compiler, null, null);
        });
        ...
        NotEquals notEquals2 = new NotEquals(anyFloatExpr, booleanExpr2);
        ...
        ContextualError result2 = assertThrows(ContextualError.class, () -> {
            notEquals2.verifyExpr(compiler, null, null);
        });
