...
public class TestMinusWithoutMock {
    ...
    public void testType() throws ContextualError {
        ...
        TestPlusWithoutMock.DummyIntExpression left = new TestPlusWithoutMock.DummyIntExpression();
        TestPlusWithoutMock.DummyIntExpression right = new TestPlusWithoutMock.DummyIntExpression();
