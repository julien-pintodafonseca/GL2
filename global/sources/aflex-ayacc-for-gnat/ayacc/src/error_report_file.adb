...
with Ayacc_File_Names, Ada.Text_IO, Source_File, Str_pack;
use Ayacc_File_Names, Ada.Text_IO;
...
--    
  ...
  begin
    Create(The_File, Out_File, Get_Error_Report_File_Name & ".ads");
    ...
    Close(The_File);
    Create(The_File, Out_File, Get_Error_Report_File_Name & ".adb");
    Write_Line("with Ada.Text_IO;");
    ...
    Write_Line("");
    Write_Line("    The_File : Ada.Text_IO.File_Type;");
    Write_Line("");
    ...
    Write_Line("      begin");
    Write_Line("        Ada.Text_IO.Create(The_File, Ada.Text_IO.Out_File, " & 
